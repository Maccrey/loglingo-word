...
export const envSchema = z.object({
  ...
  CAT_SICK_AFTER_NO_PLAY_HOURS: z.coerce.number().default(24),
  CAT_SICK_AFTER_SMELLY_HOURS: z.coerce.number().default(24),
  CAT_DEATH_AFTER_NO_FEED_DAYS: z.coerce.number().default(3),
  CAT_SICK_HOURS: z.coerce.number().default(24),
